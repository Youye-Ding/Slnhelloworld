...
namespace Echart
{
    public partial class HW1_AdmissionByProvince : System.Web.UI.Page
    {
        List<classKArrayValueJson> province = new List<classKArrayValueJson>();
        protected void Page_Load(object sender, EventArgs e)
        {
            string sql = "select * from ArtAdmissionByProvince";
            ...
            File.WriteAllText(@Server.MapPath("~/data/ArtAdmissionByProvince.json"), output);
