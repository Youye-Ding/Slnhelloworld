<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="HW1-SciAdmissionByProvince.aspx.cs" Inherits="Echart.HW1_SciAdmissionByProvince" %>
    ...
    series: [
        ...
        { name: '重庆', type: 'line', data: [] }
         ...
         $.ajax({
             type: "GET",
             async: false, //同步执行
             url: "data/SciAdmissionByProvince.json",
